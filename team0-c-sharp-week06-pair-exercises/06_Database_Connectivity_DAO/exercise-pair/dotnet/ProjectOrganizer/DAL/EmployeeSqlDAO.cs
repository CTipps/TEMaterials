...
namespace ProjectOrganizer.DAL
{
    public class EmployeeSqlDAO : IEmployeeDAO
    {
        ...
        private string sqlSearchEmployees = " SELECT * FROM employee WHERE first_name LIKE '%' + @first_name + '%' AND last_name LIKE '%' + @last_name + '%'";
        private string sqlGetEmployeesWithoutProjects = "SELECT * FROM employee LEFT JOIN project_employee ON employee.employee_id = project_employee.employee_id WHERE project_id IS NULL;";
